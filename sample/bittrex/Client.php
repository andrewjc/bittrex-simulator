...
{
	private $baseUrl;
	private $apiVersion1 = 'v1.1';
	private $apiVersion2 = 'v2.0';
	private $apiKey;
	private $apiSecret;
	...
	public function __construct ($apiKey, $apiSecret)
	{
		...
		$this->baseUrl   = 'https://bittrex.com/api';
	}
	...
	{
		if ($version == 1) 
			$uri = $this->baseUrl.'/'.$this->apiVersion1 . '/' . $method;
		else if($version == 2) 
			$uri  = $this->baseUrl . '/' . $this->apiVersion2 . '/' . $method;
	...
	/*
		V2 API Calls
	*/
	public function getTickerByDate ($market, $tickInterval)
	{
		return $this->call ('pub/market/GetTicks', array('marketName' => $market,'tickInterval'=>$tickInterval, '_'=>strtotime('now')),false,2);
	}

	public function getBTCPrice() {
		return $this->call ('pub/currencies/GetBTCPrice', array(), false, 2);
	}

	public function getChartData($market, $tickInterval) {
		$timestamp = strtotime('now');
        return $this->call('market/GetTicks', [
            'marketName' => $market,
